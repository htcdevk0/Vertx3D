                           ...
                           Vector3 position, float r, float g, float b)
{
    ...
    {
        std::cerr << "ERRO: Não foi possível inicializar FreeType" << std::endl;
        delete label;
        return nullptr;
    }
    ...
    {
        std::cerr << "ERRO: Não foi possível carregar fonte: " << fontPath << std::endl;
    ...
    for (unsigned char c = 0; c < 128; c++)
    {
        ...
        {
            std::cerr << "AVISO: Não foi possível carregar glifo: " << c << std::endl;
            continue;
        }
    ...
    std::cout << "Label criado: \"" << text << "\" com fonte " << fontPath << std::endl;
